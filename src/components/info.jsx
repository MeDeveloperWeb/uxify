...
const Info = () => {
  return (
    <section
      className="bg-gradient-to-b from-purple-50 to-purple-100 py-24 min-h-dvh flex justify-center items-center"
      id="why-us"
    >
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {infoData.map((item, index) => (
            ...
            >
              <motion.div
                className="bg-purple-100 rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-6"
                whileHover={{ rotate: 360 }}
                transition={{ duration: 0.5 }}
              >
                <item.icon className="w-12 h-12 text-purple-800" />
              </motion.div>
